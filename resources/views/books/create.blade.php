...
<ul class="nav nav-tabs" role="tablist"> 
    <li role="presentation" class="active"> 
        <a class="btn btn-primary" href="#form" aria-controls="form" role="tab" data-toggle="tab"> 
            <i class="fa fa-pencil-square-o"></i> Isi Form 
        </a> &nbsp&nbsp&nbsp&nbsp&nbsp
    </li> 
    <li role="presentation"> 
        <a class="btn btn-danger" href="#upload" aria-controls="upload" role="tab" data-toggle="tab"> 
